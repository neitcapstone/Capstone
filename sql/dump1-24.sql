...
INSERT INTO `inventory` VALUES (1,1,20,1,1),(2,2,10,2,1),(3,3,100,4,1),(4,4,90,4,1),(5,5,45,4,1);
...
INSERT INTO `location` VALUES (1,'Joe\'s Toys','1 elm str','Providence','RI','11111',1),(2,'John\'s Pants','2 main str','Providence','RI','11111',2),(3,'Mike\'s Lawns','2 Java Str','Franklin','RI','44444',3),(4,'Sally\'s Sports','3 PHP str','Boston','MA','12345',5),(5,'Bob\'s Lawns','2 Sharp Ave','Johnston','RI','33333',4),(6,'Sally\'s Sports','5 JS str','Providence','RI','99999',5);
...
INSERT INTO `product` VALUES (1,'toy','plaything','1.00',1,1,NULL),(2,'pants','size 36','20.00',2,1,NULL),(3,'Baseball','Official MLB ball','10',5,1,NULL),(4,'Football','Official NFL ball','25',5,1,NULL),(5,'Puck','Hockey Puck','15',5,1,NULL);
...
INSERT INTO `sale_product` VALUES (1,1,'2013-02-02',1,1,1),(2,2,'2012-01-01',2,2,2),(3,4,'2012-01-01',3,5,5),(4,6,'2012-01-01',4,5,6);
...
INSERT INTO `service` VALUES (1,3,'Lawn Cut','Basic lawn cut',20),(6,3,'Bush Grooming','trim hedges',25),(7,3,'Seed Lawn','Lawn seeding',30);
...
INSERT INTO `service_schedule` VALUES (2,3,1,'03:00:00','2014-01-20'),(7,3,6,'13:00:00','2014-02-15'),(8,3,7,'02:00:00','2014-03-23');
...
INSERT INTO `user_admin` VALUES (1,'joe@joe.com','Joe','Sample','xxx'),(2,'john@john.com','John','Doe','xxx'),(3,'mike@mike.com','Mike','Sav','xxx'),(4,'bob@bob.com','Bob','Jones','xxx'),(5,'sal@sal.com','Sally','Smith','xxx'),(6,'jack@jack.com','Jack','Rola','xxx'),(7,'josh@josh.com','Josh','Legoff','xxx');
...
-- Dump completed on 2014-01-24 17:47:00
