...
INSERT INTO `customer` VALUES (1,'Fred','Freddy','f@fred.com','666-666-6666','34 5th ave','Cranston','RI','11111',1,1),(2,'Barb','Smth','barb@b.com','222-222-2222','2 1st str','Boston','MA','23456',2,1),(3,'Jim','Doey','j@JJ.com','444-444-4444','23 cat AVe','Johnson','RI','23445',3,1),(4,'Don','Duck','d@d.com','111-111-3456','23 dog AVe','Braintree','MA','12344',3,1),(5,'Gizmo','Stripe','g@h.com','234-789-3466','45 goofy st','Cranston','MA','43211',5,1),(6,'Tommy','Boy','bb@bbb.com','345-235-9876','12 1st ave','Hope','RI','23545',5,1);
...
INSERT INTO `inventory` VALUES (1,1,20,1,1),(2,2,10,2,1),(3,3,20,4,1),(4,3,100,4,1),(5,4,45,4,1);
...
INSERT INTO `product` VALUES (1,'toy','plaything','1.00',1,1,NULL),(2,'pants','size 36','20.00',2,1,NULL),(3,'Baseball','Official MLB ball','10',5,1,'34-pyt'),(4,'Soccer Ball','Official NFL ball','25',5,1,'23-ert'),(5,'Puck','Hockey Puck','15',5,1,'gh-09');
...
INSERT INTO `sale_product` VALUES (1,1,'2013-02-02',1,1,1,1,1),(2,2,'2012-01-01',2,2,2,2,1),(3,4,'2012-01-01',4,5,5,4,1),(4,4,'2012-04-02',5,5,6,12,1),(6,6,'2012-04-01',5,5,6,2,1);
...
INSERT INTO `sale_service` VALUES (4,'2013-03-04',3,1,3,3,2,1),(5,'2014-01-05',3,6,3,4,3,1),(6,'2014-01-05',7,1,3,3,1,1);
...
INSERT INTO `service` VALUES (1,3,'Lawn trim','Basic lawn cut',12,1),(6,3,'Bush Grooming','trim hedges',11,1),(7,3,'Seed Lawn','Lawn seeding',30,1);
...
INSERT INTO `service_schedule` VALUES (2,3,6,'03:00:00','2013-01-20',4,1),(7,3,6,'13:00:00','2014-02-16',4,1),(8,3,7,'02:00:00','2014-03-23',3,1);
...
INSERT INTO `user_admin` VALUES (1,'joe@joe.com','Joe','Sample','xxx',1),(2,'john@john.com','John','Doe','xxx',1),(3,'mike1@mike.com','Mike','Sav','a9993e364706816aba3e25717850c26c9cd0d89d',1),(4,'bob@bob.com','Bob','Jones','xxx',1),(5,'sal@sal.com','Sally','Smith','a9993e364706816aba3e25717850c26c9cd0d89d',1),(6,'jack@jack.com','Jack','Rola','xxx',1),(7,'josh@josh.com','Josh','Legoff','xxx',1),(8,'mike@mike.com','mike','savvy','a9993e364706816aba3e25717850c26c9cd0d89d',1);
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateProdTable`(in price dec, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateServSalesTable`(in dte date, in idloc int, in idserv int, 
	in idcust int, in hours int, in id int)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateServTable`(in price dec, 
...
-- Dump completed on 2014-02-13 23:18:14
