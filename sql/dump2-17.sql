...
INSERT INTO `customer` VALUES (1,'Fred','Freddy','f@fred.com','666-666-6666','34 5th ave','Cranston','RI','11111',1,1),(2,'Barb','Smth','barb@b.com','222-222-2222','2 1st str','Boston','MA','23456',2,1),(3,'Jim','Doey','j@JJ.com','444-444-4444','23 cat AVe','Johnson','RI','23445',3,1),(4,'Don','Duck','d@d.com','111-111-3456','23 dog AVe','Braintree','MA','12344',3,1),(5,'Gizmo','Stripe','g@h.com','234-789-3466','45 goofy st','Cranston','MA','43211',5,1),(6,'Tommy','Boy','tt@bb.com','345-235-9876','12 1st ave','Hope','RI','23545',5,1),(7,'Slick','Rick','bb@bbb.com','222-222-2222','44 main st','Bronx','CT','66666',5,1),(8,'Unregistered',NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,0),(9,'Unregistered',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,0),(10,'Unregistered','',NULL,'','','','','',5,0),(11,'Bob','Fogarty','bob@neit.edu','109-987-8746','5 neit drive','e greenwich','RI','99999',5,1),(12,'Mike','shop','bob@neit.com','2347893466','5 JS str','44 main st','RI','66666',3,1);
...
INSERT INTO `sale_product` VALUES (1,1,'2013-02-02',1,1,1,1,1),(2,2,'2012-01-01',2,2,2,2,1),(3,4,'2012-01-01',4,5,5,4,1),(4,4,'2012-04-02',5,5,6,12,1),(6,6,'2012-04-01',5,5,6,2,1),(7,4,'2014-02-16',5,5,5,5,1),(8,4,'0000-00-00',20,5,5,1,1),(10,4,'0000-00-00',4,5,11,5,1),(12,8,'2012-04-02',5,5,7,12,1);
...
INSERT INTO `sale_service` VALUES (4,'2013-03-04',3,1,3,3,2.23,1),(5,'2014-01-05',3,6,3,4,3.00,1),(6,'2014-01-05',7,1,3,3,2.50,1),(7,'2013-01-20',3,9,3,12,3.00,1),(8,'2012-04-02',3,1,3,3,1.50,1);
...
INSERT INTO `service` VALUES (1,3,'Lawn trim','Basic lawn cut',12.34,1),(6,3,'Bush Grooming','trim hedges',11.00,1),(7,3,'Seed Lawn','Lawn seeding',30.00,1),(8,3,'Gardening','Gardening',12.00,0),(9,3,'Gardening','Gardening',12.56,1);
...
-- Dump completed on 2014-02-17 22:05:14
