...
INSERT INTO `sale_product` VALUES (1,1,'2013-02-02',1,1,1,1,1),(2,2,'2012-01-01',2,2,2,2,1),(3,4,'2012-01-01',3,5,5,3,1),(4,6,'2012-04-01',4,5,6,2,1),(6,6,'2012-04-01',5,5,6,2,1);
...
INSERT INTO `sale_service` VALUES (4,'2013-03-04',3,1,3,3,2,1),(5,'2014-01-05',3,6,3,4,3,1),(6,'2014-01-05',7,1,3,3,2,1);
...
FROM product p, inventory i, user_admin u
WHERE p.idproduct = i.idproduct AND u.iduser = p.iduser AND u.iduser = nid;
...
BEGIN
SELECT p.fName, p.lName, p.idcustomer
...
-- Dump completed on 2014-02-09 22:22:16
