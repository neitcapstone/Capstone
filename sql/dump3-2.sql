...
INSERT INTO `customer` VALUES (1,'Fred','Freddy','f@fred.com','666-666-6666','34 5th ave','Cranston','RI','11111',3,1),(2,'Barb','Smth','barb@b.com','222-222-2222','2 1st str','Boston','MA','23456',3,1),(3,'Jim','Doey','j@JJ.com','444-444-4449','23 cat AVe','Johnson','RI','23445',3,1),(4,'Don','Duck','d@d.com','111-111-3456','23 dog AVe','Braintree','MA','12344',5,1),(5,'Gizmo','Stripe','g@h.com','234-789-3466','45 goofy st','Cranston','MA','43211',5,1),(6,'Tommy','Boy','tt@bb.com','345-235-9876','12 1st ave','Hope','RI','23545',3,1),(7,'Slick','Rick','bb@bbb.com','222-222-2222','44 main st','Bronx','CT','66666',3,1),(8,'Unregistered',NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,0),(9,'Unregistered',NULL,NULL,NULL,NULL,NULL,NULL,'',3,0),(11,'Bob','Fogarty','bob@neit.edu','109-987-8746','5 neit drive','e greenwich','RI','99999',3,1),(12,'Mike','shop','bob@neit.com','2347893466','5 JS str','44 main st','RI','66666',3,1);
...
INSERT INTO `employee` VALUES (1,'Gary','Simmons','222-222-2222','1 new str','Providence','RI','22222','000999888',1,1),(2,'Sally','Silly','111-111-1111','20 bob ave','Providence','RI','44444','123456789',2,1),(3,'Bob','Smite','555-555-5555','34 g ave','Johnston','RI','33333','234234234',3,1),(4,'Jane','Gurr','444-444-4444','43 first ave','Attleboro','MA','44444','234782354',3,1),(5,'Missy','Lister','111-111-1111','44 main st','Putnam','CT','55555','435567890',5,1),(6,'Mickey','Mouse','777-777-7777','23 circle ave','Hope','RI','66666','099782354',5,1),(7,'John','Wayne','333-444-5555','23 g ave','Wakefield','RI','43434','098765432',3,1),(8,'Urtha','Kitt','222-222-2222','100 Grand Concourse','Cranston','RI','11111','234-45-7890',5,1),(9,'Mike','Rick','567-567-5675','5 JS str','Providence','RI','66666','234-78-4567',5,1),(10,'Slick','Rick','222-222-2222','44 main st','dfg','mm','66666','234',3,1),(11,'Slick','Rick','','','dfg','','66666','',3,0);
...
INSERT INTO `product` VALUES (1,'toy','plaything',1.00,1,1,NULL),(2,'pants','size 36',20.00,2,1,NULL),(3,'Baseball','Official MLB ball',10.00,5,1,'34-pyi'),(4,'Soccer Ball','Official NFL ball',25.00,5,1,'23-ert'),(5,'Puck','Hockey Puck',6.79,5,1,'gh-09'),(20,'Bat','baseball Bat',7.78,5,1,'45-pyy'),(27,'Slick','Rick',5.00,1,1,'dfg'),(28,'Slick','Rick',5.00,1,1,'dfg'),(29,'Slick','Rick',5.00,1,1,'dfg'),(30,'Helmet','Football helmet boys size 12-14 head and face',10.12,5,1,'sdfsdf');
...
INSERT INTO `sale_product` VALUES (1,1,1,1,1,1,1,NULL),(2,2,2,2,2,2,1,NULL),(3,4,30,5,5,4,1,'2014-01-05'),(4,4,5,5,6,12,1,NULL),(6,6,5,5,6,20,1,NULL),(7,4,5,5,5,5,0,NULL),(8,4,20,5,6,1,1,NULL),(10,4,4,5,11,5,0,NULL),(12,8,5,5,7,12,1,NULL),(13,4,4,5,5,12,1,NULL),(14,8,4,5,6,3,1,NULL),(15,4,20,5,11,5,1,NULL),(16,6,3,5,11,1,1,NULL),(17,4,30,5,11,20,0,NULL),(19,6,5,5,5,4,0,NULL),(20,8,3,5,7,5,0,NULL),(21,4,30,5,4,4,1,'01-01-2012'),(22,4,20,5,5,20,1,NULL),(23,4,4,5,11,1,1,NULL),(24,6,30,5,6,0,1,''),(25,4,30,5,6,12,1,''),(26,4,3,5,8,4,1,'2012-04-02');
...
INSERT INTO `sale_service` VALUES (4,7,6,3,3,500.00,1,''),(5,3,6,3,12,3.00,1,'2014-01-05'),(6,7,1,3,9,2.50,0,NULL),(7,3,9,3,12,3.00,1,NULL),(8,3,1,3,3,1.50,1,NULL),(9,3,7,3,12,1.00,1,'');
...
CREATE TABLE `service` (
  ...
  `desc` varchar(45) DEFAULT NULL,
  `price-hour` decimal(18,2) DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `service` VALUES (1,3,'Lawn trim','Basic lawn cut',12.37,0),(6,3,'Bush Grooming','trim hedges',11.00,1),(7,3,'Seed Lawn','Lawn seeding',30.00,1),(9,3,'Gardening','Gardening',12.56,0);
...
INSERT INTO `service_schedule` VALUES (2,3,6,3,1,'Jan 23, 2002',''),(7,3,6,4,1,NULL,NULL),(8,3,7,3,1,NULL,NULL),(9,3,9,4,1,NULL,NULL),(10,3,6,12,1,'2014-02-16','3pm'),(11,3,6,12,1,'','2:00pm');
...
-- Dump completed on 2014-03-02 14:24:21
